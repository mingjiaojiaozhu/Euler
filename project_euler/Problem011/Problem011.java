...
public class Problem011 {
    public void solution() {
        int[][] target = new int[][]{{8, 2, 22, 97, 38, 15, 0, 40, 0, 75, 4, 5, 7, 78, 52, 12, 50, 77, 91, 8},
        ...
        int result = calculateRow(target, length, size, product, 0);
    ...
    private int calculateRow(int[][] target, int length, int size, Product product, int pivot) {
        for (int i = 0; i < length; ++i) {
            ...
            while (product.indexColumn < length) {
                int value = target[product.indexRow][product.indexColumn];
                if (0 != value) {
    ...
    private int calculateColumn(int[][] target, int length, int size, Product product, int pivot) {
        for (int i = 0; i < length; ++i) {
            product.value = 1;
            product.indexRow = 0;
    ...
    private int calculateDiagonalLeft(int[][] target, int length, int size, Product product, int pivot) {
    ...
    private int calculateDiagonalRight(int[][] target, int length, int size, Product product, int pivot) {
        for (int i = length - size; i >= 0; --i) {
            product.value = 1;
            product.indexRow = 0;
            product.indexColumn = i;
    ...
    private int calculateLeft(int[][] target, int length, int size, Product product, int pivot) {
    ...
    private int calculateRight(int[][] target, int length, int size, Product product, int pivot) {
    ...
    private void multiplyRow(int[][] target, int length, int size, Product product) {
    ...
    private void multiplyColumn(int[][] target, int length, int size, Product product) {
    ...
    private void multiplyLeft(int[][] target, int length, int size, Product product) {
    ...
    private void multiplyRight(int[][] target, int length, int size, Product product) {
    ...
    private static class Product {
        ...
        public Product(int value, int indexRow, int indexColumn) {
            this.value = value;
