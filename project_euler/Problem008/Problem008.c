...
static void multiply(char *target, int length, int size, Product *product);

void Problem008(void) {
    char *target = "73167176531330624919225119674426574742355349194934"
    ...
    long long result = product->value;
    while (product->index < length) {
        int value = target[product->index] - '0';
        if (value) {
