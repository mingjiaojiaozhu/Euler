...
after following the instructions, it is returned to the bottom of the pile. There are sixteen cards in each pile,
...
* [c program](Problem084.c)
* [c++ program](Problem084.cpp)
* [golang program](Problem084.go)
* [java program](Problem084.java)
* [javascript program](Problem084.js)
* [python program](Problem084.py)
